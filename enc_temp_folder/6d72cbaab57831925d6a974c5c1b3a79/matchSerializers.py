...
from core.models.matchmodel import OpenMatch, MatchRequest, MatchJoinRequest, MatchInvitation
...
class MatchInvitationSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        if self.instance and self.instance.status in ['accepted', 'rejected']:
            raise serializers.ValidationError("Invitation status cannot be changed once accepted or rejected.")
        return data